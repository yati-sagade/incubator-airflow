...
class DAG(BaseDag, LoggingMixin):
    ...
    def descendents(self, dagbag, task_ids=[], include_downstream=False,
        ...
        for dag_name, dag in dagbag.dags.items():
            ...
            descendents.append(dependent_dag)
            if recursive:
                descendents.extend(dependent_dag.descendents(dagbag, include_downstream=include_downstream, include_upstream=include_upstream, recursive=recursive))
        return descendents
